    ...
    <AdminLayout>
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-gray-500 font-medium mt-1">Gerencie as categorias de notícias do portal.</p>
        </div>
        <button 
          onClick={() => openModal()}
          className="bg-primary hover:bg-primary/90 text-white font-bold py-2.5 px-5 rounded-xl shadow-lg shadow-primary/20 flex items-center gap-2 transition-transform hover:-translate-y-0.5"
        >
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden animate-in fade-in zoom-in duration-200">
            ...
            <form onSubmit={handleSubmit} className="p-6">
              ...
              <div className="mt-8 flex justify-end gap-3">
                ...
                <button type="submit" disabled={createMutation.isPending || updateMutation.isPending} className="px-5 py-2.5 rounded-xl font-bold bg-primary text-white hover:bg-primary/90 shadow-lg shadow-primary/20 transition-all disabled:opacity-50">
                  Salvar
                </button>
              </div>
            </form>
