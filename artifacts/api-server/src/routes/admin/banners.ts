...
const VALID_POSITIONS = [
  "TOP", "TOP_MOBILE", "ABOVE_DESTAQUE", "BELOW_DESTAQUE", "BELOW_ARTICULISTAS",
  "ABOVE_POLITICA", "SIDE_POLITICA", "SIDE_GERAL",
  "ABOVE_ULTIMAS_NOTICIAS", "BELOW_MAIS_LIDAS",
  "ABOVE_PROGRAMAS", "ABOVE_ULTIMAS_NOTICIAS_NEW", "ABOVE_NAVEGAR",
  "BELOW_PLAYER", "SIDEBAR", "BETWEEN_SECTIONS", "FOOTER",
  "MID_NEWS",
] as const;
